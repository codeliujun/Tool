...
//			self.statusLabel.text = MJRefreshHeaderPullToRefresh;
            self.statusLabel.text = [ZHLanguage localizedStringFromTable:@"refreshHeaderPullToRefresh"];
...
//            self.statusLabel.text = MJRefreshHeaderReleaseToRefresh;
            self.statusLabel.text = [ZHLanguage localizedStringFromTable:@"refreshHeaderReleaseToRefresh"];
...
//            self.statusLabel.text = MJRefreshHeaderRefreshing;
            self.statusLabel.text = [ZHLanguage localizedStringFromTable:@"refreshHeaderRefreshing"];

...
//            self.statusLabel.text = MJRefreshFooterPullToRefresh;
            self.statusLabel.text = [ZHLanguage localizedStringFromTable:@"refreshFooterPullToRefresh"];
...
//            self.statusLabel.text = MJRefreshFooterReleaseToRefresh;
            self.statusLabel.text = [ZHLanguage localizedStringFromTable:@"refreshFooterReleaseToRefresh"];
...
//            self.statusLabel.text = MJRefreshFooterRefreshing;
            self.statusLabel.text = [ZHLanguage localizedStringFromTable:@"refreshFooterRefreshing"];
